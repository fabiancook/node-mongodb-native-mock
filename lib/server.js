...
const MongoDB        = require('mongodb'),
      ...
      MongoDBCore    = require('mongodb-core'),
      TwoSixWireProtocolSupport = require('mongodb-core/lib/wireprotocol/2_6_support'),
      ThreeTwoWireProtocolSupport = require('mongodb-core/lib/wireprotocol/3_2_support'),
      Command        = require('./command'),
      Sinon          = require('sinon'),
      CoreCommands   = require('mongodb-core/lib/connection/commands'),
